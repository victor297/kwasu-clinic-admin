...
export const CreateReport = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/reports/create`, data);
    console.log(res);
    return res.data;
    // dispatch({
...
export const AddPatients = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/patients/register`, data);
    return res.data;
    // dispatch({
...
export const CreateBeds = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/beds/add`, data);
    return res.data;
    // dispatch({
...
export const CreatePayment = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/payments/add`, data);
...
export const GetBeds = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(`${url}/beds`);
    console.log(res);
    dispatch({
...
export const CreateBooking = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/appointments/create`, data);
    console.log(res);
...
export const GetSingleBed = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/beds/single`, data);
    // console.log(res);
    return res.data;
    // dispatch({
...
export const EditSingleBed = (data, id) => async (dispatch) => {
  try {
    dispatch({ type: types.GET_SINGLE_BEDS_REQUEST });
    const res = await axios.patch(`${url}/beds/${id}`, data);
    // console.log(res);
    return res.data;
    // dispatch({
    //   type: types.GET_SINGLE_BEDS_SUCCESS,
...
export const dischargePatient = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(`${url}/beds/discharge`, data);
    console.log(res);
    // return res.data;
    dispatch({
