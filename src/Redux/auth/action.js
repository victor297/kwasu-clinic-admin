...
export const NurseLogin = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/nurses/login`, data);
    dispatch({
...
export const DoctorLogin = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/doctors/login`, data);
...
export const DoctorRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/doctors/register`, data);
    // console.log(res);
    return res.data;
    // dispatch({
...
export const NurseRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/nurses/register`, data);
    // console.log(res);
    return res.data;
    // dispatch({
...
export const AmbulanceRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/ambulances/add`, data);
    console.log(res);
    // dispatch({
...
export const UpdateNurse = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(`${url}/nurses/${id}`, data);
    console.log(res);
...
export const UpdateDoctor = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(`${url}/doctors/${id}`, data);
    console.log(res);
...
export const SendPassword = (data) => async (dispatch) => {
  try {
    dispatch({ type: types.EDIT_DOCTOR_REQUEST });
    const res = await axios.post(`${url}/admin/password`, data);
    // console.log(res);
    return res.data;
  } catch (error) {
    console.log(error);
...
export const forgetPassword = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`${url}/admin/forgot`, data);
    // console.log(res);
    return res.data;
  } catch (error) {
    console.log(error);
